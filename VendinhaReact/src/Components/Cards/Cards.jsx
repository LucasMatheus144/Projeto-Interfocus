            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.restante}>
                    ...
                    <div className={styles.nova}>
                        <button onClick={() => setDividaAberto(true)}>Adicionar Divida</button>
                    </div>
                </div>
                <Mais isOpen={maisAberto} onClose={() => setMaisAberto(false)} cliente={cliente} attform={onAtualizar} />
                <Divida isOpen={dividaAberto} onClose={() => setDividaAberto(false)} onAtualizar={onAtualizar} obj={cliente} view={false} />
            </div>
        </>
    );
}